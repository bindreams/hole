...
/// type at all — adding the impl would mean adding the dependency, which
/// creates the capability it would guard. `Debug` is the live sink here, and
/// `ServerEntry`'s own is redacted.
