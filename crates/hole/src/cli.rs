    ...
    match action {
        ProxyAction::Start {
            ...
            let request = BridgeRequest::Start {
                ...
                // The CLI has no Settings preference to push; `None` leaves
                // whatever startup preference is already persisted untouched
                // (#979 — a `Some` here would stomp a real GUI preference).
                on_startup: None,
            };
